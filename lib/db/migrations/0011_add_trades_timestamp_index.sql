...
-- Note: CONCURRENTLY is not allowed inside a transaction and was removed here.
-- These indexes are idempotent (IF NOT EXISTS) and safe to run inside a migration.
...
CREATE INDEX IF NOT EXISTS idx_trades_timestamp_token
