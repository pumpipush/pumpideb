...
export const tokensTable = pgTable("tokens", {
  ...
  virtualTokenReserves: text("virtual_token_reserves").notNull().default("0"),
  virtualEthReserves: text("virtual_eth_reserves").notNull().default("0"),
  realTokenReserves: text("real_token_reserves").notNull().default("0"),
