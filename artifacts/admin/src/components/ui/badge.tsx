  ...
  "inline-flex items-center rounded-md border px-2 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        blue: "border-transparent bg-blue-500/20 text-blue-500 hover:bg-blue-500/30",
        purple: "border-transparent bg-purple-500/20 text-purple-500 hover:bg-purple-500/30",
        amber: "border-transparent bg-amber-500/20 text-amber-500 hover:bg-amber-500/30",
      },
    },
    defaultVariants: {
      variant: "default",
