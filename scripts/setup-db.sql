...
CREATE TABLE IF NOT EXISTS tokens (
  ...
  virtual_token_reserves  TEXT NOT NULL DEFAULT '1000000000000000000000000000',
  virtual_eth_reserves    TEXT NOT NULL DEFAULT '3000000000000000000000',
  real_token_reserves     TEXT NOT NULL DEFAULT '1000000000000000000000000000',
  real_eth_reserves       TEXT NOT NULL DEFAULT '0',
  total_supply            TEXT NOT NULL DEFAULT '1000000000000000000000000000',
  market_cap_eth          TEXT,
  price_eth               TEXT,
